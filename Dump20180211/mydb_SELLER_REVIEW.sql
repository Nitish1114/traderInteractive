...
CREATE TABLE `SELLER_REVIEW` (
  ...
  CONSTRAINT `Sellerid` FOREIGN KEY (`SELLER_ID`) REFERENCES `SELLER` (`SELLER_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `SELLER_REVIEW` VALUES (1,123,'Lorem Ipsum is simply dummy text of the printing and typesetting industry');
